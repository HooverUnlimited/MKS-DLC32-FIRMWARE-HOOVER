...
/*
    20231202 Hoover:    Copied from i2s_out_xyz_mks_dlc32.h
                        Resetting for my Two Trees (TTC) 450 CNC Router 
                        Some of these affect Grbl_Esp32/src/Settings.Deinitions.cpp
...
#define MACHINE_NAME    "HOOVER'S TTC450"
#define BOARD_NAME      "Board: MakerBase MKS DLC32 CNC V2.0"
#define FW_NAME         "V0.0.1"
...
#define DEFAULT_X_MAX_TRAVEL 460.0 // mm NOTE: Must be a positive value.
#define DEFAULT_Y_MAX_TRAVEL 460.0 // mm NOTE: Must be a positive value.
